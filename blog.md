...
I tried to format my code using the Formatter but it messed up my style a lot. now fixing the style. Need to change the interface to abstract class. I have to remove my helper file now.